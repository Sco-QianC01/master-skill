...
explain() {
  cat <<'EOT'
这个 SOP 走查脚本帮你完成 "SEO 内容营销 (一人规模)" 工作流。

一句话: 从零流量到稳定有机搜索带来付费试用
...
declare -a SOP_STEPS=(
  "关键词研究: 用 Ahrefs/Semrush 找竞品已排名的关键词，筛选 KD<30 + 月搜索 >200 的词 evidence: [T03-S006]"
  "内容规划: 建 3 类内容——问题型 (\"how to X\")、比较型 (\"X vs Y\")、替代品型 (\"X alternatives\")"
  "文章生产: 每周 1-2 篇，长度 1500-3000 字，结构化 (H2/H3/FAQ 结构)，内链回产品"
  "技术 SEO 基础: 提交 sitemap、修复 Core Web Vitals、确保移动端适配"
  "建外链: 找竞品被引用的资源页，申请替换；或写原创数据研究吸引自然引用"
  "跟踪排名: 每月用 Ahrefs/GSC 检查关键词排名变化，调整低效文章"
)
