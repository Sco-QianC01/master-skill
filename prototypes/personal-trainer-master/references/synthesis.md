# Synthesis — 健身私教 (Personal Trainer)

> Phase 2 提炼结果。198 sources across 6 tracks, 100% first-hand (34 verified_primary + 164 surrogate_primary). Research date: 2026-05-23.
...
当私教面对一个新问题或新客户场景时,按以下 7 个维度做功课:

### 9.1 客户画像评估
- **看什么**: 年龄、训练年限、伤病史、生活方式(久坐/活跃)、心理动机(外在/内在)
- **怎么查**: PAR-Q+ 问卷 + 初次咨询面谈 + 医疗转介记录(如适用)
- **为什么**: 同一个"减脂"目标,20 岁大学生和 55 岁久坐办公族的方案完全不同

### 9.2 动作能力基线
- **看什么**: FMS 评分、主要代偿模式(膝内扣/骨盆前倾/肩上举受限)、关节活动度
- **怎么查**: FMS 7 项 + 过头深蹲评估 + 主动关节活动度测试
- **为什么**: 在不了解客户动作能力时设计方案,等于没看地图就开车

### 9.3 训练方案匹配
- **看什么**: 客户目标 × 训练年限 → 适合的周期化模式、训练频率、动作选择
- **怎么查**: 对照 NSCA/NASM 编程指南 + 客户可用设备和时间约束
- **为什么**: 方案必须匹配客户当前能力和可执行条件,而非教练的个人偏好

### 9.4 营养与恢复状态
- **看什么**: 当前饮食模式(是否达到蛋白质目标)、睡眠质量、生活压力水平
- **怎么查**: 3-7 天饮食日志(MFP/Cronometer)+ 睡眠追踪(可穿戴设备或主观问卷)
- **为什么**: 训练只是刺激,适应发生在恢复期——营养和睡眠是训练效果的约束变量

### 9.5 执业边界检查
- **看什么**: 客户的需求是否超出私教执业范围(需要医学诊断/临床营养/心理干预)
- **怎么查**: 对照 ACSM 风险分层 + 当地执业法规 + 认证机构 scope of practice 文件
- **为什么**: 跨越边界不仅是法律风险,更是客户安全风险——及时转介是专业标志

### 9.6 工具选型
- **看什么**: 当前客户量 × 服务形式(线下/线上/混合) × 预算 → 适合的平台和设备
- **怎么查**: Track 02 选型决策树 + 同行评价(SBS/PTDC 社区)+ 免费试用
- **为什么**: 工具是效率杠杆——选对平台省 5h/周,选错浪费 5h/周

### 9.7 持续学习方向
- **看什么**: 当前技能缺口(通过客户反馈和自我评估识别)+ 行业趋势(MASS/SBS/NSCA 会议)
- **怎么查**: MASS Research Review 月刊 + NSCA/ACSM 年会议程 + Barbell Medicine 播客
- **为什么**: 运动科学每 3-5 年有显著更新——不持续学习的教练在用过时的方法
